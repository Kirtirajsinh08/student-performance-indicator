...
class DataTransformation:
        ...
        try:
            ...
            cat_pipeline = Pipeline(
                steps=[
                    ...
                    ("scaler", StandardScaler(with_mean=False))  # ✅ better for sparse matrix
                ]
            )
            ...
            return preprocessor   # ✅ missing return added
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            input_feature_test_arr = preprocessing_obj.transform(input_feature_test_df)  # ✅ fixed

            train_arr = np.c_[input_feature_train_arr, np.array(target_feature_train_df)]  # ✅ fixed
